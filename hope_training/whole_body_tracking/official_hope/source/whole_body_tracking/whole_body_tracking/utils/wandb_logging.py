...
_HITTER_LIVE_EXACT = {
    ...
    "Live/Reward/total",
    "Live/Reward/original_total",
    "Live/Reward/amp",
    "Live/Reward/amp_weighted",
    "Live/Reward/total_with_amp",
    "Live/Reward/task_reward",
    "Live/Reward/tracking_reward",
    "Live/Reward/stability_reward",
...
_HITTER_RACKET_METRICS = {
    ...
    "base_mocap_age_s",
    "base_mocap_stale",
    "target_delay_steps_in_effect",
    "target_robustness_scale",
    "arm_torque_utilization_mean",
    "arm_torque_utilization_p95",
    "arm_torque_utilization_p99",
    "arm_torque_utilization_max",
    "arm_torque_fraction_over_90pct",
    "arm_torque_fraction_over_100pct",
    "torque_headroom_utilization_mean",
    "torque_headroom_utilization_p95",
    "torque_headroom_utilization_p99",
    "torque_headroom_utilization_max",
    "torque_headroom_over_safe_fraction",
    "torque_headroom_saturation_fraction",
    "all_active_torque_utilization_mean",
    "all_active_torque_utilization_p95",
    "all_active_torque_utilization_p99",
    "all_active_torque_utilization_max",
    "all_active_torque_fraction_over_90pct",
    "all_active_torque_fraction_over_100pct",
    "racket_side_torque_utilization_mean",
    "racket_side_torque_utilization_p95",
    "racket_side_torque_utilization_p99",
    "racket_side_torque_utilization_max",
    "racket_side_torque_fraction_over_90pct",
    "racket_side_torque_fraction_over_100pct",
    "legs_torque_utilization_mean",
    "legs_torque_utilization_p95",
    "legs_torque_utilization_p99",
    "legs_torque_utilization_max",
    "legs_torque_fraction_over_90pct",
    "legs_torque_fraction_over_100pct",
    "waist_torque_utilization_mean",
    "waist_torque_utilization_p95",
    "waist_torque_utilization_p99",
    "waist_torque_utilization_max",
    "waist_torque_fraction_over_90pct",
    "waist_torque_fraction_over_100pct",
    ...
    "pd_passive_damping_multiplier_mean",
    "motor_capacity_nominal_env",
    "motor_capacity_multiplier_mean",
    "motor_capacity_multiplier_min",
    "motor_capacity_multiplier_max",
    "external_push_scale",
    "external_push_count",
