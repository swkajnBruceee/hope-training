...
class ExampleCommandFeed(RacketCommandSource):
    ...
    # model_21800 metadata box centers.  The old public examples were useful for
    # wiring tests but outside the actor's trained hitter_pure distribution.
    forehand_pos: tuple = (0.58, -0.44, 1.075)
    backhand_pos: tuple = (0.58, -0.09, 1.075)
    forehand_vel: tuple = (1.92, 0.19, 1.03)
    backhand_vel: tuple = (2.05, -0.13, 0.675)
