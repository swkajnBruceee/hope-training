...
# before any IsaacLab/Isaac Sim module touches them. usdrt is only present in
# full Isaac Sim runtime installs; the headless pip metapackage shipped with
# `pip install isaacsim` does NOT bundle it. Treat its absence as non-fatal
# so headless training can still load this package.
try:
