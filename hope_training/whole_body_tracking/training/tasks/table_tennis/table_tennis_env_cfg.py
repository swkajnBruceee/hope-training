...
class TableTennisEnvCfg(ManagerBasedRLEnvCfg):
    ...
    ball_truth_udp_host: str = "127.0.0.1"
    ball_truth_udp_port: int = 19531

    def __post_init__(self):
        # General.
        self.decimation = 4
        self.episode_length_s = 8.0
        # Simulation — 360 Hz physics matches the HOPE mocap/planner reference rate and, together with
        # PhysX CCD, keeps the fast, light ball from tunnelling through the thin racket blade / net,
        # including at struck-return speeds (15-25 m/s, where dt alone is not enough); 90 Hz control.
        # The aero callback runs at the 360 Hz physics rate. CCD is a
