...
#include "joint_msgs/msg/detail/command__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const joint_msgs::msg::Command & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  joint_msgs::msg::Command & ros_message)
{
  // Member: name
  cdr >> ros_message.name;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = joint_msgs::msg::Command;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const joint_msgs::msg::Command *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<joint_msgs::msg::Command *>(
    untyped_ros_message);
...
get_message_type_support_handle<joint_msgs::msg::Command>()
{
  return &joint_msgs::msg::typesupport_fastrtps_cpp::_Command__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, joint_msgs, msg, Command)() {
  return &joint_msgs::msg::typesupport_fastrtps_cpp::_Command__handle;
}
