...
#include "joint_msgs/msg/detail/state__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const joint_msgs::msg::State & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  joint_msgs::msg::State & ros_message)
{
  // Member: name
  cdr >> ros_message.name;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = joint_msgs::msg::State;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const joint_msgs::msg::State *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<joint_msgs::msg::State *>(
    untyped_ros_message);
...
get_message_type_support_handle<joint_msgs::msg::State>()
{
  return &joint_msgs::msg::typesupport_fastrtps_cpp::_State__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, joint_msgs, msg, State)() {
  return &joint_msgs::msg::typesupport_fastrtps_cpp::_State__handle;
}
