...
bool
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_joint_msgs
cdr_serialize(
  const joint_msgs::msg::JointCommand & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Member: joints
  {
    ...
    for (size_t i = 0; i < size; i++) {
      joint_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  joint_msgs::msg::JointCommand & ros_message)
{
  // Member: header
  ...
  // Member: joints
  {
    ...
    for (size_t i = 0; i < size; i++) {
      joint_msgs::msg::typesupport_fastrtps_cpp::cdr_deserialize(
  ...
  size_t current_alignment)
{
  ...
  // Member: joints
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        joint_msgs::msg::typesupport_fastrtps_cpp::get_serialized_size(
  ...
  size_t current_alignment)
{
  ...
  // Member: joints
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        joint_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_Command(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = joint_msgs::msg::JointCommand;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const joint_msgs::msg::JointCommand *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<joint_msgs::msg::JointCommand *>(
    untyped_ros_message);
...
template<>
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_joint_msgs
const rosidl_message_type_support_t *
get_message_type_support_handle<joint_msgs::msg::JointCommand>()
{
  return &joint_msgs::msg::typesupport_fastrtps_cpp::_JointCommand__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, joint_msgs, msg, JointCommand)() {
  return &joint_msgs::msg::typesupport_fastrtps_cpp::_JointCommand__handle;
}
