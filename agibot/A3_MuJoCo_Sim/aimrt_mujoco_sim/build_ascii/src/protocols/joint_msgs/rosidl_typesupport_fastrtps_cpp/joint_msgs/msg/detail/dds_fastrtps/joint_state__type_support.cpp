...
cdr_serialize(
  const joint_msgs::msg::JointState & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  joint_msgs::msg::JointState & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  // Member: joints
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        joint_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_State(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = joint_msgs::msg::JointState;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const joint_msgs::msg::JointState *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<joint_msgs::msg::JointState *>(
    untyped_ros_message);
...
{
  return &joint_msgs::msg::typesupport_fastrtps_cpp::_JointState__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, joint_msgs, msg, JointState)() {
  return &joint_msgs::msg::typesupport_fastrtps_cpp::_JointState__handle;
}
