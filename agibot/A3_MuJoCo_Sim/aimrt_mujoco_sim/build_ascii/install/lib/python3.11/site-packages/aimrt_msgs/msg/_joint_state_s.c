...
bool aimrt_msgs__msg__joint_state__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("aimrt_msgs.msg._joint_state.JointState", full_classname_dest, 38) == 0);
  }
  aimrt_msgs__msg__JointState * ros_message = _ros_message;
  {  // name
...
PyObject * aimrt_msgs__msg__joint_state__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("aimrt_msgs.msg._joint_state");
