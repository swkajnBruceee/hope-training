...
PROTOBUF_NAMESPACE_OPEN
template<> ::aimrt::protocols::common::Error* Arena::CreateMaybeMessage<::aimrt::protocols::common::Error>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace aimrt {
namespace protocols {
namespace common {
...
class Error final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:aimrt.protocols.common.Error) */ {
 public:
  ...
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "aimrt.protocols.common.Error";
  }
  protected:
  ...
  // @@protoc_insertion_point(class_scope:aimrt.protocols.common.Error)
 private:
  class _Internal;
...
inline int64_t Error::_internal_code() const {
  return _impl_.code_;
}
inline int64_t Error::code() const {
  // @@protoc_insertion_point(field_get:aimrt.protocols.common.Error.code)
  return _internal_code();
}
inline void Error::_internal_set_code(int64_t value) {
  
  _impl_.code_ = value;
}
inline void Error::set_code(int64_t value) {
  _internal_set_code(value);
  // @@protoc_insertion_point(field_set:aimrt.protocols.common.Error.code)
}
...
inline const std::string& Error::msg() const {
  // @@protoc_insertion_point(field_get:aimrt.protocols.common.Error.msg)
...
void Error::set_msg(ArgT0&& arg0, ArgT... args) {
 ...
 _impl_.msg_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:aimrt.protocols.common.Error.msg)
}
inline std::string* Error::mutable_msg() {
  std::string* _s = _internal_mutable_msg();
  // @@protoc_insertion_point(field_mutable:aimrt.protocols.common.Error.msg)
  return _s;
}
...
inline std::string* Error::release_msg() {
  // @@protoc_insertion_point(field_release:aimrt.protocols.common.Error.msg)
...
inline void Error::set_allocated_msg(std::string* msg) {
  ...
  // @@protoc_insertion_point(field_set_allocated:aimrt.protocols.common.Error.msg)
}
