...
bool aimrt_msgs__msg__joint_command__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("aimrt_msgs.msg._joint_command.JointCommand", full_classname_dest, 42) == 0);
  }
  aimrt_msgs__msg__JointCommand * ros_message = _ros_message;
  {  // name
  ...
  {  // stiffness
    ...
    assert(PyFloat_Check(field));
    ros_message->stiffness = PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
  {  // damping
...
PyObject * aimrt_msgs__msg__joint_command__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("aimrt_msgs.msg._joint_command");
  ...
  {  // stiffness
    PyObject * field = NULL;
    field = PyFloat_FromDouble(ros_message->stiffness);
    {
