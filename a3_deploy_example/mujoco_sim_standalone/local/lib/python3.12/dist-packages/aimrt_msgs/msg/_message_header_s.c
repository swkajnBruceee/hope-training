...
bool aimrt_msgs__msg__message_header__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("aimrt_msgs.msg._message_header.MessageHeader", full_classname_dest, 44) == 0);
  }
  aimrt_msgs__msg__MessageHeader * ros_message = _ros_message;
  {  // stamp
...
{
  /* NOTE(esteve): Call constructor of MessageHeader */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("aimrt_msgs.msg._message_header");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "MessageHeader");
