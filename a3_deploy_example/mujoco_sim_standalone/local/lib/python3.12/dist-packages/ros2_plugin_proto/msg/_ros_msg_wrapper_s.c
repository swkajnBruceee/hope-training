...
bool ros2_plugin_proto__msg__ros_msg_wrapper__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("ros2_plugin_proto.msg._ros_msg_wrapper.RosMsgWrapper", full_classname_dest, 52) == 0);
  }
  ros2_plugin_proto__msg__RosMsgWrapper * ros_message = _ros_message;
  {  // serialization_type
...
{
  /* NOTE(esteve): Call constructor of RosMsgWrapper */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("ros2_plugin_proto.msg._ros_msg_wrapper");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "RosMsgWrapper");
