...
class FootSensor(metaclass=Metaclass_FootSensor):
    ...
    def __init__(self, **kwargs):
        ...
        self.presure = array.array('h', kwargs.get('presure', []))
    ...
    @builtins.property
    def presure(self):
        """Message field 'presure'."""
        return self._presure

    @presure.setter
    def presure(self, value):
        if isinstance(value, array.array):
            assert value.typecode == 'h', \
                "The 'presure' array.array() must have the type code of 'h'"
            self._presure = value
            return
        if __debug__:
            ...
            assert \
                ...
                "The 'presure' field must be a set or sequence and each value of type 'int' and each integer in [-32768, 32767]"
        self._presure = array.array('h', value)
