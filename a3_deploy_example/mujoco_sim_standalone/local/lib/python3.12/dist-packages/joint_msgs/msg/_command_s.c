...
bool joint_msgs__msg__command__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("joint_msgs.msg._command.Command", full_classname_dest, 31) == 0);
  }
  joint_msgs__msg__Command * ros_message = _ros_message;
  {  // name
...
PyObject * joint_msgs__msg__command__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("joint_msgs.msg._command");
