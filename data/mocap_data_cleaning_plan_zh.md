...
本文档是后续处理 `data/DATA260703` 动捕数据的主计划。目标不是只把文件切成片段，而是把 Motive/OptiTrack 导出的原始乒乓数据稳定清洗成可供以下流程使用的统一样本：
...
```text
data/analysis/mocap/DATA260703_analysis.md
data/analysis/mocap/DATA260703_racket_skeleton_matching.md
data/analysis/mocap/DATA260703_selected_clip_ranking.md
data/analysis/mocap/clips/
data/analysis/mocap/selected_clips/
```

已有探索脚本：

```text
data/analysis/mocap/analyze_motive_dataset.py
data/analysis/mocap/cut_bvh_candidates.py
data/analysis/mocap/match_rackets_to_skeletons.py
data/analysis/mocap/rank_selected_clips.py
```
...
```text
data/analysis/mocap/selected_clips/Table_Tennis_01_005_TennisBats01_90p11_92p11_Skeleton001.bvh
data/analysis/mocap/selected_clips/Table_Tennis_01_012_TennisBats01_115p69_117p69_Skeleton001.bvh
data/analysis/mocap/selected_clips/Table_Tennis_01_004_TennisBats02_51p86_53p86_Skeleton002.bvh
```
...
```text
data/analysis/mocap/             保留现有探索脚本和生成结果
data/analysis/mocap_cleaning/    放正式清洗逻辑
docs/                       放计划和接口说明
...
```text
data/analysis/mocap_cleaning_outputs/DATA260703/debug_plots/<episode_id>/
```
...
```text
data/analysis/mocap_cleaning_outputs/DATA260703/samples/<episode_id>.npz
```
...
```text
data/analysis/mocap_cleaning_outputs/DATA260703/manifest.json
```
...
```text
data/analysis/mocap_cleaning_outputs/DATA260703/ball_source_report.md
```
...
```text
1. 不修改 data/DATA260703 原始数据
2. 所有输出写入 data/analysis/mocap_cleaning_outputs/
3. 探索脚本保留，正式逻辑放入 data/analysis/mocap_cleaning/
...
```text
data/analysis/mocap_cleaning/configs/DATA260703.yaml
```
...
```text
data/analysis/mocap_cleaning/motive_loader.py
data/analysis/mocap_cleaning/derivative.py
data/analysis/mocap_cleaning/hit_detection.py
data/analysis/mocap_cleaning/export_dataset.py
data/analysis/mocap_cleaning/plotting.py
data/analysis/mocap_cleaning/cli_clean_one.py
data/analysis/mocap_cleaning/configs/DATA260703.yaml
```
...
python3 -m analysis.mocap_cleaning.cli_clean_one \
  ...
  --start 90.11 \
  --end 92.11 \
  --output-dir data/analysis/mocap_cleaning_outputs/DATA260703
```
...
```text
data/analysis/mocap_cleaning_outputs/DATA260703/samples/<episode_id>.npz
data/analysis/mocap_cleaning_outputs/DATA260703/metadata/<episode_id>.json
data/analysis/mocap_cleaning_outputs/DATA260703/debug_plots/<episode_id>/*.png
```
