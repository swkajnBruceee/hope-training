...
def main() -> None:
    ...
    parser.add_argument(
        "--csv",
        type=Path,
        default=Path("data/DATA260703/Csv/Rige Body/Table Tennis_01_005.csv"),
    )
    parser.add_argument("--racket", default="TennisBats01")
    parser.add_argument("--skeleton", default="Skeleton 001")
    parser.add_argument("--output", type=Path, default=Path("data/analysis/mocap_cleaning_outputs/DATA260703/loader_validation.json"))
