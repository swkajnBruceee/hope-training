...
def main() -> None:
    ...
    parser.add_argument("--analysis-json", type=Path, default=Path("data/analysis/mocap/DATA260703_analysis.json"))
    parser.add_argument("--dataset", type=Path, default=Path("data/DATA260703"))
    parser.add_argument("--output-dir", type=Path, default=Path("data/analysis/mocap/clips"))
