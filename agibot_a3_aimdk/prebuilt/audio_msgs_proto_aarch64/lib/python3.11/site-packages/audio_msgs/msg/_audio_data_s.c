...
bool audio_msgs__msg__audio_data__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("audio_msgs.msg._audio_data.AudioData", full_classname_dest, 36) == 0);
  }
  audio_msgs__msg__AudioData * ros_message = _ros_message;
  {  // data
...
PyObject * audio_msgs__msg__audio_data__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("audio_msgs.msg._audio_data");
