...
def main() -> None:
    ...
    parser.add_argument(
        "--cleaned-windows-dir",
        type=Path,
        default=Path("analysis/mocap_cleaning_outputs/DATA260703/cleaned_windows"),
    )
    parser.add_argument(
        "--cleaned-report",
        type=Path,
        default=Path("analysis/mocap_cleaning_outputs/DATA260703/cleaned_tennis_windows_report.json"),
    )
